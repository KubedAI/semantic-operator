---
title: "Flights (model only)"
description: "A second authoring example showing model structure and physical binding."
---
...
(`examples/retail/`) is a full runnable end-to-end demo with a data
...
```bash
go run ./cmd/ossiectl validate -f examples/flights/semanticmodel.yaml
