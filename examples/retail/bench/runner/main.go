...
//
// Env: same as the nl comparison (examples/retail/nl).
package main
...
func main() {
	qfile := flag.String("questions", "examples/retail/bench/questions.yaml", "question set")
	out := flag.String("out", "examples/retail/bench/RESULTS.md", "markdown report path")
